<section class="banner-container">
	...
	<section class="descricao-autor">
		<div class="center">
			<div class="w50 left">
				<h2>Samuel Rosa Costa</h2>
				<p>
					Olá, tudo bem? Me chamo Samuel, não possuo experiência em programação,
					mas sei que irei adquirir com muita dedicação e perseverança a esta profissão 
					de grande futuro!
					Sinta-se livre para olhar o meu site, e o código em meu Github. :)
				</p>
			</div>
			<div class="w50 left">
